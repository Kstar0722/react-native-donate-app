    ...
    onSignupClick = () => {
        switch (this.state.signupType) {
            case 1: // Business Signup...
                this.props.navigation.navigate('SignupBusiness', {bType: 0})
                break;
            case 2: // Team Signup...
                this.props.navigation.navigate('SignupGeneral', {bType: 1})
                break;
            case 3: // Individual Signup...
                this.props.navigation.navigate('SignupGeneral', {bType: 2})
                break;
