...
export default class SignupHelpIndividual extends React.Component {
            ...
            <ImageBackground source={Images.signbg_new} style={styles.container} resizeMode='cover' >
                ...
                <View style={styles.content}>
                    <ImageBackground style={styles.rectFrame} source={Images.right_rectangle_frame} resizeMode={'contain'} >
                        <Image style={styles.rectFrameIcon} source={Images.person_sel} resizeMode={'contain'} />
                        <Text style={styles.rectFrameTitleText} >Individual</Text>
